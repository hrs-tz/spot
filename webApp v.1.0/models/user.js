...
// static method to update user's username password and permission
userSchema.statics.updateProfile = async function(id, oldPassword, username, password, permission) {
